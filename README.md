...
## *About this guide, it took me real time to write, structure, and organize in the right order so the instructions are easier to follow. I created it based on the personal difficulties I had months ago when trying to understand the tools and concepts myself.*
