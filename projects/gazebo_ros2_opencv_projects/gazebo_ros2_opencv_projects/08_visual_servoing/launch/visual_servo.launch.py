#!/usr/bin/env python3
"""Auto-generated bringup: custom Gazebo world + TurtleBot3 (waffle) + the visual_servoing node.
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='visual_servoing', executable='visual_servo_node', name='visual_servo',
            output='screen',
        ),
    ])
