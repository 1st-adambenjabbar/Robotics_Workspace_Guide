#!/usr/bin/env python3
"""Auto-generated bringup: custom Gazebo world + TurtleBot3 (waffle) + the aruco_navigation node.
...
def generate_launch_description():
    pkg_share = get_package_share_directory('aruco_navigation')
    world = os.path.join(pkg_share, 'worlds', 'markers.world')
    ...
    return LaunchDescription([
        ...
        Node(
            package='aruco_navigation', executable='aruco_nav_node', name='aruco_nav',
            output='screen',
        ),
    ])
