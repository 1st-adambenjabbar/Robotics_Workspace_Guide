#!/usr/bin/env python3
"""Auto-generated bringup: custom Gazebo world + TurtleBot3 (waffle) + the color_detection node.
...
def generate_launch_description():
    pkg_share = get_package_share_directory('color_detection')
    ...
    return LaunchDescription([
        ...
        Node(
            package='color_detection', executable='color_detector', name='color_detector',
            output='screen',
        ),
    ])
